...
#Transformando essa lista de tuplas em dicionários
...
#Para remover um elemento de um dicionário, eu:
#Método Pop e passo a chave como argumento da função POP
